...
namespace Resources {
    ...
    internal class ErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Поле &apos;{0}&apos; не является корректным e-mail адресом.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Значение &apos;{0}&apos; не является корректным для поля &apos;{1}&apos;.
        /// </summary>
